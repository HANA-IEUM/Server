...
public class MoneyBoxSettingsController {
    ...
    @Operation(summary = "머니박스 생성", description = "버킷리스트에 연결된 새로운 머니박스를 생성합니다. (계좌 생성 + 설정 연결)")
    @ApiResponses({
    ...
    @Operation(summary = "머니박스 별명 수정", description = "머니박스의 별명을 수정합니다.")
    @ApiResponses({
    ...
    @Operation(summary = "머니박스 설정 삭제", description = "머니박스 설정을 삭제합니다.")
    @ApiResponses({
